...
def parallel_bLARS_svm_data(LARS_Ahallow,block,ff,i):
    ...
    for i in range(iterations):
        ...
        A_hallow.extend(B)
        print("rank: ", np.linalg.matrix_rank(A[:, A_hallow]))
        print("size: ", A[:, A_hallow].shape)
        print("the thing itself: ", A[:, A_hallow])
